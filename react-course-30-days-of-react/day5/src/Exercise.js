...
const HexaColorCard = (props) => {

    const hexColors = props.hexColors.map(hexColor => {
...
const ProfesionalExperience = ({ user: { userName, userSurName, location, role, techs } }) => {
